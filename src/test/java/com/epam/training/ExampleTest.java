...
public class ExampleTest {
    ...
    public void testExample() {
        ...
        element.submit();
        WebElement breadCrumbElement = new WebDriverWait(driver,20)
        		.until(ExpectedConditions.presenceOfElementLocated(By.id("search")));
        Assert.assertTrue("Title mismatch", driver.getTitle().contains("searchText"));
    }
